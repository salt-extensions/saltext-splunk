...
The saltext-splunk project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-splunk.git
...
* Writing blog posts
* Sharing your experiences using Salt + Splunk
  on social media
...
[docs]: https://salt-extensions.github.io/saltext-splunk/
