...
The saltext-splunk project team welcomes contributions from the community.
...
```bash
# Clone the repo
git clone --origin salt git@github.com:salt-extensions/saltext-splunk.git

# Change to the repo dir
cd saltext-splunk

# Create a new venv
python3 -m venv env --prompt saltext-splunk
...
* Writing blog posts
* Posting on social media about how you used Salt+Splunk to solve your
...
[issues]: https://github.com/salt-extensions/saltext-splunk/issues
[PRs]: https://github.com/salt-extensions/saltext-splunk/pulls
[discussions]: https://github.com/salt-extensions/saltext-splunk/discussions
